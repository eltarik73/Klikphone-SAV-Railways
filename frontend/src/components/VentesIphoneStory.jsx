...
// Logo Apple officiel (silhouette) — SVG inline pour branding produit
      ...
      <div className="px-6 py-5 border-b border-white/10 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <div className="w-11 h-11 rounded-xl bg-white flex items-center justify-center shadow-lg">
            <AppleLogo className="w-5 h-5 text-black" fill="black" />
          </div>
          <div>
            <h2 className="text-lg font-bold text-white tracking-tight flex items-center gap-2">
              Ventes iPhone
              <span className="text-orange-400 text-xs font-semibold">STORIES</span>
            </h2>
